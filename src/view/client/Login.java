    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    ln.socket = new Socket("localhost", 5555);
                    ln.output = new PrintWriter(ln.socket.getOutputStream(), true);
                    ln.input = new BufferedReader(new InputStreamReader(ln.socket.getInputStream()));
                } catch (IOException ex) {
                    Logger.getLogger(Login.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
